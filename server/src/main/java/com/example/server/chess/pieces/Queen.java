...
public class Queen extends Piece{
    ...
    public boolean isColumnExclusion(int currentPosition, int candidateOffset) {
        boolean firstColumnExclusion = BoardUtils.FIRST_COLUMN[currentPosition] && (candidateOffset == -1 || candidateOffset == -9 || candidateOffset == 7);

        boolean eighthColumnExclusion = BoardUtils.EIGHTH_COLUMN[currentPosition] && (candidateOffset == 1 || candidateOffset == 9 || candidateOffset == -7);
